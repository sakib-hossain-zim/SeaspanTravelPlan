...
class EditBudgetSelectionPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
     data: [],
  ...
  onRowSelect = (row) => {
    ...
    for(const prop in row){
      ...
      localStorage.setItem('BudgetEventSelection_TravelProgram',abcd[0]);
      ...
      <div className="container" style={{marginTop:10}}>
        ...
        <div style={{width: 552.5,
          ...
          <TableHeaderColumn isKey dataField="travel_program" filter={{type: 'TextFilter', delay:1000}} width="500">
            ...
            <div><p>Click "OK" to go to the Event Selection.</p></div>
            <br />
            <br />

            <button  type= "submit"  >
            <a href= '/editBudgetEventSelectionPage' class="text-muted"> OK </a>
            </button>
...
EditBudgetSelectionPage.propTypes = {
